...
export function ContactSection() {
  return (
    <section id="kapcsolat" className="py-16 md:py-24 lg:py-32 relative">
            ...
            <div className="space-y-5 md:space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                <a href={`tel:${BUSINESS.phone}`} className="glass glass-hover rounded-xl p-3 md:p-4 flex items-center gap-3 transition-all">
                  <div className="w-9 h-9 md:w-10 md:h-10 rounded-lg bg-white/5 flex items-center justify-center text-dtl-chrome flex-shrink-0">
